...
class OtoSend extends StatefulWidget {
  final String phoneNumber;

  const OtoSend({required this.phoneNumber, Key? key}) : super(key: key);

  @override
  State<OtoSend> createState() => _OtoSendState();
}

class _OtoSendState extends State<OtoSend> {
